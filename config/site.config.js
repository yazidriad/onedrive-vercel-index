...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'yazid@sm8s.onmicrosoft.com',
  ...
  baseDirectory: 'https://sm8s-my.sharepoint.com/personal/yazid_sm8s_onmicrosoft_com/Documents/upgrade',
